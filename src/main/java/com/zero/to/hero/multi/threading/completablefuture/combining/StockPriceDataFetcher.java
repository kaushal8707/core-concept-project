...
public class StockPriceDataFetcher {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<Object> anyOfResults =
                CompletableFuture.anyOf(api1Results, api2Results); //Returns a new CompletableFuture that is completed
                                                                   // when any of the given CompletableFutures complete
        //process the result
